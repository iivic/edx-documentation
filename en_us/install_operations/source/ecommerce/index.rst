...
Django administration site and the E-Commerce Administration Tool (E-CAT). The
E-CAT is a web app that is included with the E-Commerce service. The E-CAT
enables you to configure and manage products that are associated with the
courses on your instance of the Open edX learning management system (LMS).
